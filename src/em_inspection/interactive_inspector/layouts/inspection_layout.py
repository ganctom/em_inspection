                                ...
                                [
                                    ...
                                    html.Div(
                                        [
                                            html.H6(
                                                "Grid Navigator",
                                                className="mt-2 text-uppercase text-muted small",
                                            ),
                                            dbc.Row(
                                                [
                                                    # Slider & Manual Entry
                                        ...
                                        [
                                            html.Div(
                                                [
                                                    html.H6(
                                                        "Basket",
                                                        className="mb-0 small text-uppercase text-muted",
                                                    ),
                                                    html.Div(
                                                        [
                                                            dbc.Button(
                                        ...
                                        [
                                            html.Div(
                                                [
                                                    html.H6(
                                                        "Log",
                                                        className="m-0 small text-uppercase text-muted",
                                                    ),
                                                    dbc.Button(
                    ...
                    dbc.Col(
                        [
                            ...
                            dbc.NavbarSimple(
                                ...
                                color="white",
                                className="mb-0 py-1 shadow-none border-bottom",
                                style={"height": "40px"},
                            ),
                                        ...
                                        [
                                            ...
                                            dbc.Col(
                                                [
                                                    ...
                                                    dbc.Input(
                                                        id={
                                                            "type": "nudge-stitch_config",
                                                            "index": "step",
                                                        },  # Changed from "nudge-step"
                                                        type="number",
                                                        value=10,
                                                        size="sm",
                                                        style={"width": "65px"},
