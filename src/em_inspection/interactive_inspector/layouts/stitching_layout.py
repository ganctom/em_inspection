...
def layout(active_service=None):
    ...
    return dbc.Container(
        [
                                            ...
                                            dbc.Row(
                                                [
                                                    ...
                                                    dbc.Col(
                                                        [
                                                            dbc.Button(
                                                                **UI.BTN_STITCH_PPLN_RUN
                                                            ),
                                                            dbc.Button(
                                                                **UI.BTN_STITCH_PPLN_ABORT
                                                            ),
                                                            dcc.RadioItems(
                    ...
                    dbc.Col(
                        [
                                ...
                                [
                                    dbc.Button(
                                        [
                                            ...
                                            "Missing Stitched Sections",
                                        ],
                                        id=UI.ID_STITCH_UTILS_MISSING,
                                        color="info",
                                        size="sm",
                                        className="me-2",
                                    )
                            ...
                            html.Div(
                                ...
                                className="mt-3 fw-bold small text-secondary",
                            ),
            ...
            dcc.Interval(
                id=UI.ID_STITCH_PPLN_PROGRESS_INT, interval=1000, disabled=True
            ),
