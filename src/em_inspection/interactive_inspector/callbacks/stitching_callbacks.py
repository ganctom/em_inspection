...
def start_stitching_pipeline(
        n_clicks, parallel_value, range_str, selected_steps,
        config_path, scl_fct, settings_data
):
...
def sync_pipeline_progress(n, current_logs):
    return StitchingWorkflowManager.sync_progress(n_intervals=n, current_logs=current_logs)
